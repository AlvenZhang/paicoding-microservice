...
import com.github.paicoding.service.UserPwdEncoder;
import com.github.paicoding.service.UserService;
import com.github.paicoding.service.UserSessionHelper;
...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    private OriginClient statisticsClient;
    ...
    public UserStatisticInfoDTO queryUserInfoWithStatistic(Long userId) {
        ...
        UserStatisticInfoDTO userHomeDTO = statisticsClient.queryUserStatisticInfo(userId);
        ...
        // 创作历程
        List<YearArticleDTO> yearArticleDTOS = articleClient.listYearArticleByUserId(userId);
