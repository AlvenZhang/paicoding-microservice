...
public class UserViewController extends BaseViewController {
    ...
    @Resource
    private OriginClient articleReadService;

    @Resource
    private OriginClient seoService;
